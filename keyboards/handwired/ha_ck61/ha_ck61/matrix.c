...
//  Modified by Xydane/chbw
static matrix_row_t read_cols(void){
  return ((palReadPad(GPIOA, 10)==PAL_LOW) ? 0 : (1<<0))
       | ((palReadPad(GPIOA,  9)==PAL_LOW) ? 0 : (1<<1))
       | ((palReadPad(GPIOA,  8)==PAL_LOW) ? 0 : (1<<2))
       | ((palReadPad(GPIOB, 15)==PAL_LOW) ? 0 : (1<<3))
       | ((palReadPad(GPIOB, 14)==PAL_LOW) ? 0 : (1<<4))
       | ((palReadPad(GPIOB, 13)==PAL_LOW) ? 0 : (1<<5))
       | ((palReadPad(GPIOB, 12)==PAL_LOW) ? 0 : (1<<6))
       | ((palReadPad(GPIOA,  7)==PAL_LOW) ? 0 : (1<<7))
       | ((palReadPad(GPIOA,  6)==PAL_LOW) ? 0 : (1<<8))
       | ((palReadPad(GPIOA,  5)==PAL_LOW) ? 0 : (1<<9))
       | ((palReadPad(GPIOA,  4)==PAL_LOW) ? 0 : (1<<10))
       | ((palReadPad(GPIOA,  3)==PAL_LOW) ? 0 : (1<<11))
       | ((palReadPad(GPIOA,  2)==PAL_LOW) ? 0 : (1<<12))
       | ((palReadPad(GPIOA,  1)==PAL_LOW) ? 0 : (1<<13))
       | ((palReadPad(GPIOA,  0)==PAL_LOW) ? 0 : (1<<14));
}
